...
(def wrist-rest-back-height 27)				;;height of the back of the wrist rest--Default 34
(def wrist-rest-angle 2) 				 ;;angle of the wrist rest--Default 20
...
(def wrist-rest-y-angle 0)	
;; (def wrist-rest-on 1) 						;;0 for no rest 1 for a rest connection cut out in bottom case		
;; ;(def wrist-rest-back-height 35)				;;height of the back of the wrist rest--Default 34
;; (def wrist-rest-back-height 32)				;;height of the back of the wrist rest--Default 34
;; ;(def wrist-rest-angle 20) 				 ;;angle of the wrist rest--Default 20
;; (def wrist-rest-angle 17.5) 				 ;;angle of the wrist rest--Default 20
;; (def wrist-rest-rotation-angle 8)			;;0 default The angle in counter clockwise the wrist rest is at		
;; (def wrist-rest-ledge 3.5)					;;The height of ledge the silicone wrist rest fits inside
;; (def wrist-rest-y-angle 8)					;;0 Default.  Controls the wrist rest y axis tilt (left to right)
...
;; ;; (def wrist-rest-rotation-angle 8)			;;0 default The angle in counter clockwise the wrist rest is at		
;; (def wrist-rest-ledge 3.5)					;;The height of ledge the silicone wrist rest fits inside
;; (def wrist-rest-y-angle 6.5)					;;0 Default.  Controls the wrist rest y axis tilt (left to right)
